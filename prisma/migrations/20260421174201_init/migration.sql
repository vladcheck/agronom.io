...
-- CreateTable
CREATE TABLE "vehicles_in_warehouses" (
    "id" BIGSERIAL NOT NULL,
    "vehicle_id" BIGINT NOT NULL,
    "warehouse_id" BIGINT NOT NULL,

    CONSTRAINT "vehicles_in_warehouses_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "fertilizers_in_warehouses" (
    "id" BIGSERIAL NOT NULL,
    "fertilizer_id" BIGINT NOT NULL,
    "warehouse_id" BIGINT NOT NULL,
    "count" INTEGER NOT NULL DEFAULT 0,

    CONSTRAINT "fertilizers_in_warehouses_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "vehicles_in_warehouses_warehouse_id_idx" ON "vehicles_in_warehouses"("warehouse_id");

-- CreateIndex
CREATE INDEX "fertilizers_in_warehouses_warehouse_id_idx" ON "fertilizers_in_warehouses"("warehouse_id");
...
-- AddForeignKey
ALTER TABLE "warehouses" ADD CONSTRAINT "warehouses_enterprise_id_fkey" FOREIGN KEY ("enterprise_id") REFERENCES "enterprises"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "vehicles_in_warehouses" ADD CONSTRAINT "vehicles_in_warehouses_vehicle_id_fkey" FOREIGN KEY ("vehicle_id") REFERENCES "vehicles"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "vehicles_in_warehouses" ADD CONSTRAINT "vehicles_in_warehouses_warehouse_id_fkey" FOREIGN KEY ("warehouse_id") REFERENCES "warehouses"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "fertilizers_in_warehouses" ADD CONSTRAINT "fertilizers_in_warehouses_fertilizer_id_fkey" FOREIGN KEY ("fertilizer_id") REFERENCES "fertilizers"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "fertilizers_in_warehouses" ADD CONSTRAINT "fertilizers_in_warehouses_warehouse_id_fkey" FOREIGN KEY ("warehouse_id") REFERENCES "warehouses"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
